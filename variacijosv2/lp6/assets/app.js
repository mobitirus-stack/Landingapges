(function () {
  ...
  var yearSelect = document.getElementById("lp6-year");
  var errorBox = document.getElementById("lp6-error");
  var successBox = document.getElementById("lp6-success");
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      var gender = form.querySelector('input[name="lp6-gender"]:checked');
      var day = form.querySelector("#lp6-day").value;
      var month = form.querySelector("#lp6-month").value;
      var year = form.querySelector("#lp6-year").value;
