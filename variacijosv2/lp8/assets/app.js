(function () {
  ...
  var errorBox = document.getElementById("lp8-error");
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      var gender = form.querySelector('input[name="lp8-gender"]:checked');
      var day = form.querySelector("#lp8-day").value;
      var month = form.querySelector("#lp8-month").value;
      var year = form.querySelector("#lp8-year").value;
