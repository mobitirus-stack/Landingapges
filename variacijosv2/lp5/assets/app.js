(function () {
  ...
  var daySelect = document.getElementById("lp5-day");
  var yearSelect = document.getElementById("lp5-year");
  var form = document.getElementById("lp5-form");
  var errorBox = document.getElementById("lp5-form-error");
  var successBox = document.getElementById("lp5-success");
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      var day = document.getElementById("lp5-day").value;
      var month = document.getElementById("lp5-month").value;
      var year = document.getElementById("lp5-year").value;
